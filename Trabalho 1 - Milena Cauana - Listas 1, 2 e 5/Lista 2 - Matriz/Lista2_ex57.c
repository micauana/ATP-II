/*Milena Cauana - Lista 2 - Exercicio 57: Escreva um programa em C que multiplique uma matriz 2x3 por
uma matriz 3x2 e armazene o resultafo em uma matriz 2x2.*/
#include<stdio.h>
#include<stdlib.h>
#include<time.h>
...
int main ()
{
    ...
    printf("\nMatriz Resultante: \n");
    imprimindo_matriz(2, 2, matriz_resultante);
